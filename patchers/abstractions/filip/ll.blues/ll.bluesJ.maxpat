{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 241.0, 479.0, 159.0, 53.0 ],
		"bglocked" : 0,
		"defrect" : [ 241.0, 479.0, 159.0, 53.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-119",
					"items" : [ "no", ",", "buffer_host1", ",", "ho_st1", ",", "jit.player1", ",", "wavelets1", ",", "xgroove@1" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 146.0, 36.0, 13.0, 18.0 ],
					"pattrmode" : 1,
					"rounded" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"types" : [  ],
