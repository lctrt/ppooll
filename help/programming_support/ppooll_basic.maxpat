...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.5, 340.0, 196.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 313.0, 346.0, 128.0, 22.0 ],
					"text" : "actmaker ppooll_basic",
					"varname" : "act"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 162.0, 366.0, 80.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 18.0, 364.0, 20.0, 20.0 ],
					"varname" : "rj_on"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 18.0, 389.0, 65.0, 22.0 ],
					"text" : "qmetro 20"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 43.0, 364.0, 100.0, 22.0 ],
					"pattrmode" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 18.0, 412.0, 75.0, 22.0 ],
					"text" : "ll.rj jit_menu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 132.0, 219.0, 65.0, 22.0 ],
					"text" : "ll.ra sigo 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 18.0, 220.0, 61.0, 22.0 ],
					"text" : "ll.ra sigi 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 313.0, 323.0, 113.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.5, 340.0, 300.0, 102.0 ]
				}
