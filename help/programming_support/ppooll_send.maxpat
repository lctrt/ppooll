...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-14",
					"items" : [ "no", ",", "_objects_overview1", ",", "ho_st1", ",", "ppooll_basic1", ",", "ppooll_send1" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 37.5, 273.0, 163.0, 22.0 ],
					"text" : "ll.sa sigactmenu sigparmenu"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595186999999999,
					"id" : "obj-4",
					"items" : [ "no", ",", "_objects_overview1", ",", "ho_st1", ",", "ll.par.maxhelp1", ",", "ll.sa.maxhelp1", ",", "ppooll_basic1", ",", "ppooll_send1" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
