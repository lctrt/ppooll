...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 71.0, 9.0, 61.0, 10.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "list" ],
					"overloadcolor" : [ 1.0, 0.039216, 0.039216, 0.490196 ],
					"patching_rect" : [ 1.0, 9.0, 61.0, 10.0 ],
					"slidercolor" : [ 0.0, 0.019608, 0.078431, 0.0 ],
					"varname" : "meterL",
					"warmcolor" : [ 0.764706, 0.972549, 0.392157, 0.47451 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 88.0, 0.0, 44.0, 14.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.0, 39.0, 36.0, 13.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 66.0, 13.0, 66.0, 12.0 ],
					"selectcolor" : [ 0.45098, 0.670588, 1.0, 0.0 ],
					"slidercolor" : [ 0.027451, 0.023529, 0.6, 1.0 ],
					"slidercolornofocus" : [ 0.027451, 0.023529, 0.6, 1.0 ],
					"slidermax" : 1.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 0.0, 13.0, 66.0, 12.0 ],
					"selectcolor" : [ 0.45098, 0.670588, 1.0, 0.0 ],
					"slidercolor" : [ 0.027451, 0.023529, 0.6, 1.0 ],
					"slidercolornofocus" : [ 0.027451, 0.023529, 0.6, 1.0 ],
					"slidermax" : 1.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 0.0, 39.0, 84.0, 13.0 ],
					"sliderlog" : 5.0,
					"slidermax" : 20000.0,
					"slidermin" : 10.0,
					"varname" : "ramp",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 0.0, 21.0, 34.0, 19.0 ],
					"pattrmode" : 1,
					"rounded" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"types" : [  ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 32.0, 21.0, 34.0, 19.0 ],
					"pattrmode" : 1,
					"rounded" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"types" : [  ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 65.0, 21.0, 34.0, 19.0 ],
					"pattrmode" : 1,
					"rounded" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"types" : [  ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 98.0, 21.0, 34.0, 19.0 ],
					"pattrmode" : 1,
					"rounded" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"types" : [  ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 120.0, 36.0, 13.0, 18.0 ],
					"pattrmode" : 1,
					"rounded" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"types" : [  ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 66.0, 0.0, 66.0, 14.0 ],
					"selectcolor" : [ 0.996078, 1.0, 1.0, 0.447059 ],
					"slidercolor" : [ 0.027451, 0.023529, 0.6, 1.0 ],
					"slidercolornofocus" : [ 0.027451, 0.023529, 0.6, 1.0 ],
					"sliderlog" : 4.0,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 41.5, 157.5, 352.5, 157.5 ],
					"source" : [ "obj-129", 0 ]
				}
