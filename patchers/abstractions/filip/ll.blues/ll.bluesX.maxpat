...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 83.0, 8.0, 75.0, 10.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "list" ],
					"overloadcolor" : [ 1.0, 0.039216, 0.039216, 0.490196 ],
					"patching_rect" : [ 0.0, 8.0, 75.0, 10.0 ],
					"slidercolor" : [ 0.0, 0.019608, 0.078431, 0.0 ],
					"varname" : "meterL",
					"warmcolor" : [ 0.764706, 0.972549, 0.392157, 0.47451 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 115.0, 0.0, 44.0, 26.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 318.0, 12.0, 36.0, 14.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 238.0, 0.0, 80.0, 12.0 ],
					"selectcolor" : [ 0.45098, 0.670588, 1.0, 0.0 ],
					"slidercolor" : [ 0.027451, 0.023529, 0.6, 1.0 ],
					"slidercolornofocus" : [ 0.027451, 0.023529, 0.6, 1.0 ],
					"slidermax" : 1.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 159.0, 0.0, 80.0, 12.0 ],
					"selectcolor" : [ 0.45098, 0.670588, 1.0, 0.0 ],
					"slidercolor" : [ 0.027451, 0.023529, 0.6, 1.0 ],
					"slidercolornofocus" : [ 0.027451, 0.023529, 0.6, 1.0 ],
					"slidermax" : 1.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 318.0, 0.0, 49.0, 13.0 ],
					"sliderlog" : 5.0,
					"slidermax" : 20000.0,
					"slidermin" : 10.0,
					"varname" : "ramp",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 159.0, 7.0, 41.0, 19.0 ],
					"pattrmode" : 1,
					"rounded" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 198.0, 7.0, 41.0, 19.0 ],
					"pattrmode" : 1,
					"rounded" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 238.0, 7.0, 41.0, 19.0 ],
					"pattrmode" : 1,
					"rounded" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 277.0, 7.0, 41.0, 19.0 ],
					"pattrmode" : 1,
					"rounded" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 354.0, 10.0, 13.0, 18.0 ],
					"pattrmode" : 1,
					"rounded" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"varname" : "vol_sel"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 0.0, 159.0, 26.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 79.0, 0.0, 80.0, 26.0 ],
					"selectcolor" : [ 0.996078, 1.0, 1.0, 0.447059 ],
					"slidercolor" : [ 0.027451, 0.023529, 0.6, 1.0 ],
					"slidercolornofocus" : [ 0.027451, 0.023529, 0.6, 1.0 ],
					"sliderlog" : 4.0,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 207.5, 157.5, 352.5, 157.5 ],
					"source" : [ "obj-129", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Applications/Max 6.1/Cycling '74/ppooll/abstractions/ll.blues",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
