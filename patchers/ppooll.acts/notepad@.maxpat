...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 351.0, 392.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 351.0, 358.0, 40.0, 22.0 ],
					"text" : "itoa"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 351.0, 259.0, 61.0, 22.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 351.0, 323.0, 57.0, 22.0 ],
					"restore" : [ 104, 101, 108, 108, 111, 10, 99, 108, 101, 109, 101, 110, 115 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 81.0, 223.0, 150.0, 20.0 ],
					"text" : "ll.par act_menu par_menu",
					"varname" : "ll.sends"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 199.625, 0.0, 25.375, 16.0 ],
					"sliderstyle" : 2,
					"varname" : "fontsize"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 398.0, 96.0, 50.0, 21.0 ],
					"pattrmode" : 1,
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"id" : "obj-33",
					"items" : [ "no", ",", "buffer_host1", ",", "ho_st1", ",", "modul.ator1", ",", "notepad@1" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 346.0, 96.0, 50.0, 21.0 ],
					"pattrmode" : 1,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"varname" : "act_menu"
				}
...
, 			{
				"box" : 				{
					...
					"outputmode" : 1,
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 16.0, 231.0, 131.0 ],
					"rounded" : 0.0,
					"tabmode" : 0,
					"text" : "hello\nclemens",
					"varname" : "textfield"
