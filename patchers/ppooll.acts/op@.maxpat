...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 0.0, 0.0, 44.0, 16.0 ],
					"varname" : "title_LCD"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 58.0, 167.0, 22.0 ],
					"text" : "actmaker op@ \"100 100 100\"",
					"varname" : "act"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 16.0, 113.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 22.0, 0.0, 22.0, 22.0 ],
					"pattrmode" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 0.0, 22.0, 14.0 ],
					"varname" : "master"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 45.0, 182.0, 39.0, 22.0 ],
									"text" : "rtz 45"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 472.0, 20.0, 285.5, 20.0 ],
									"text" : "v3.04 - 2020/01/15 - clemens.hausch@moozak.org"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 179.333333333333343, 56.0, 84.0, 22.0 ],
									"text" : "mc.unpack~ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 122.0, 83.0, 84.0, 22.0 ],
									"text" : "mc.unpack~ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 122.0, 370.0, 76.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 391.0, 20.0, 53.0, 22.0 ],
									"text" : "ll.p right"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 162.0, 201.0, 561.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 162.0, 160.0, 547.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 162.0, 119.0, 581.0, 22.0 ],
									"text" : "ll.pm op switchOps leftMode lAbsPlus lAbsMinus rightMode rAbsPlus rAbsMinus dcBlockPreA dcBlockPreB"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 122.0, 298.0, 189.0, 22.0 ],
									"text" : "gen~ @gen op@_191019.gendsp"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 292.0, 339.0, 70.0, 22.0 ],
									"text" : "ll.pf right~ui"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 207.0, 339.0, 63.0, 22.0 ],
									"text" : "ll.pf left~ui"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 521.5, 79.0, 111.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "int", "int" ],
													"patching_rect" : [ 347.0, 220.0, 34.0, 22.0 ],
													"text" : "t 0 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "int", "int" ],
													"patching_rect" : [ 309.0, 220.0, 34.0, 22.0 ],
													"text" : "t 1 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 464.5, 155.0, 76.0, 22.0 ],
													"text" : "snapshot~ 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 449.5, 319.0, 34.0, 22.0 ],
													"text" : "gate"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 207.0, 318.0, 41.0, 22.0 ],
													"text" : "gate~"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "bang", "bang", "" ],
													"patching_rect" : [ 309.0, 183.0, 62.0, 22.0 ],
													"text" : "select 0 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 309.0, 155.0, 74.0, 22.0 ],
													"text" : "ll.p outMode"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "bang" ],
													"patching_rect" : [ 449.5, 451.0, 106.0, 22.0 ],
													"text" : "ll.p OPresult_num"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 207.0, 451.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 229.0, 79.0, 25.0, 25.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 4,
													"outlettype" : [ "", "", "", "" ],
													"patching_rect" : [ 229.0, 405.0, 144.0, 20.0 ],
													"text" : "ll.s~ act_menu par_menu"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 6,
													"outlettype" : [ "", "", "", "", "", "" ],
													"patching_rect" : [ 472.5, 405.0, 163.0, 20.0 ],
...
,
									"patching_rect" : [ 146.0, 339.0, 37.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 179.333333333333343, 20.0, 55.0, 22.0 ],
									"text" : "ll.r~ right"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 122.0, 20.0, 48.0, 22.0 ],
									"text" : "ll.r~ left"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 309.0, 20.0, 45.0, 22.0 ],
									"text" : "ll.p left"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 66.0, 264.0, 50.0, 22.0 ],
									"text" : "reset"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 162.0, 243.0, 150.0, 22.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 2 ],
									"midpoints" : [ 318.5, 88.5, 244.833333333333314, 88.5 ],
									"source" : [ "obj-133", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-6", 0 ],
									"midpoints" : [ 188.833333333333343, 49.5, 188.833333333333343, 49.5 ],
									"source" : [ "obj-136", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 171.5, 151.0, 131.5, 151.0 ],
									"source" : [ "obj-15", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 171.5, 191.5, 131.5, 191.5 ],
									"source" : [ "obj-18", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 3 ],
									"midpoints" : [ 400.5, 106.5, 301.5, 106.5 ],
									"source" : [ "obj-2", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 171.5, 234.0, 131.5, 234.0 ],
									"source" : [ "obj-20", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 131.5, 192.5, 131.5, 192.5 ],
									"source" : [ "obj-4", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 171.5, 281.0, 131.5, 281.0 ],
									"source" : [ "obj-56", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 47.0, 0.0, 181.0, 16.0 ],
					"varname" : "presets"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 230.0, 0.0, 68.0, 16.0 ],
					"varname" : "preset-ramp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 355.0, 254.0, 100.0, 22.0 ],
...
, 			{
				"name" : "op@_191019.gendsp",
				"bootpath" : "~/Documents/Max 8/Packages/ppooll/patchers/abstractions/clemens hausch",
				"patcherrelativepath" : "../abstractions/clemens hausch",
				"type" : "gDSP",
				"implicit" : 1
			}
, 			{
