...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 48.0, 1499.0, 17.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 1543.0, 589.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 81.0, 1448.0, 589.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 48.0, 1448.0, 28.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 1358.0, 830.0, 20.0 ],
					"text" : "-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 728.0, 1324.0, 142.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 689.0, 1280.0, 137.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 219.0, 510.0, 20.0 ],
					"text" : "incoming data will create a new line in the routing window."
				}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 37.0, 122.0, 356.0, 34.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 37.0, 43.0, 356.0, 48.0 ],
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int", "", "" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 37.0, 97.0, 80.0, 17.0 ],
													"pattrmode" : 1,
													"varname" : "hi_menu"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 149.0, 211.0, 482.0, 35.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 169.0, 130.0, 414.0, 35.0 ],
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int", "", "" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 101.0, 101.0, 34.0, 17.0 ],
													"textcolor" : [ 0.149, 0.149, 0.149, 1.0 ],
													"varname" : "midi_channels"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int", "", "" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 43.0, 75.0, 58.0, 17.0 ],
													"pattrmode" : 1,
													"textcolor" : [ 0.149, 0.149, 0.149, 1.0 ],
													"varname" : "midi_receive_port"
												}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 68.0, 1499.0, 532.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 1401.0, 589.0, 33.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/Max 8/Library/ppooll/ppooll-help/act_infos",
				"patcherrelativepath" : ".",
				"type" : "PNG",
				"implicit" : 1
			}
